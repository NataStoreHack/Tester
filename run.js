...
if(usePairingCode && !rxhl.authState.creds.registered) {
		const phoneNumber = await question('mohon di masukin gan nomor bot lu supaya terhubung dengan Zii X Gixx Bot di awali dengan Kode Negara:\n');
